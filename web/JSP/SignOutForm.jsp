...
<html>
    ...
    <body>
        <div id="id02" class="modal-signout">
            <form class="modal-content-signout" action="User">
                <div class="container-signout">
                    <h1>Đăng xuất</h1>
                    <p>Bạn có muốn đăng xuất không?</p>

                    <div class="clearfix">
                        <button type="button" onclick="document.getElementById('id02').style.display = 'none'" class="cancelbtn-signup">Hủy</button>
